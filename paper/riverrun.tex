...
The name is borrowed. \emph{riverrun} is the first word of Joyce's \emph{Finnegans
Wake}, a book with no beginning: its last sentence flows into its first, a river
returning to its own source. That image is the exact shape of the strongest attack
on systems like this, and of the defense against it. We kept the name and, in
Section~\ref{sec:ruler}, made the circle do real work.
...
\river's constructions. Against $2000$ synthetic members, the ``rooted decoy'' the
field ships is worth an effective $500$; the circular, origin-free construction ---
the funding cycle with no beginning, \emph{Finnegans Wake} made numeric
